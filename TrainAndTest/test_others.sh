...
#  Data/xvector/LoResNet10/army_v1/spect_egs_mean/soft_dp01
    ...
    python -W ignore TrainAndTest/test_vox1.py \
      ...
      --test-input-per-file 4 \
      --inst-norm \
      --xvector-dir Data/xvector/LoResNet${resnet_size}/army_v1/spect_egs_mean/soft_dp01_example \
      --resume  Data/checkpoint/LoResNet${resnet_size}/army_v1/spect_egs_mean/soft_dp01/checkpoint_20.pth \
      --trials trials \
      --gpu-id 0
  done
