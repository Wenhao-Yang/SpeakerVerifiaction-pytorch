...
#  sname=dev #dev_aug_com
  ...
  for test_subset in test dev; do
    ...
    python -W ignore TrainAndTest/test_egs.py \
      ...
      --embedding-size ${embedding_size} \
      --fast none1 --downsample ${downsample} \
      --encoder-type ${encod} \
      --block-type ${block_type} \
...
#      batch_size=256
    ...
    # ${input_dim}
    model_dir=${model}${resnet_size}/${datasets}/${feat_type}_egs_${mask_layer}/${loss}_${optimizer}_${scheduler}/${input_norm}_batch${batch_size}_${block_type}_red${red_ratio}${exp_str}_down${downsample}_avg${avg_size}_${encoder_type}_em${embedding_size}_dp01_alpha${alpha}_${fast}${at_str}_${chn_str}wd5e4_vares_bashuf2_dist_manifold_0.01/${seed}
