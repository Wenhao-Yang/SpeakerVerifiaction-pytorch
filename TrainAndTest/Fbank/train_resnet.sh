...
#        --class-weight ${class_weight} \
  ...
  for loss in arcsoft ; do
    ...
    python TrainAndTest/misc/train_egs_hard.py \
      ...
      --check-path Data/checkpoint/${model}${resnet_size}/${datasets}/${feat_type}_egs${subset}_${mask_layer}_hard/${loss}_${optimizer}_${scheduler}/${input_norm}_batch${batch_size}_${block_type}_down${downsample}_${fast}_${encoder_type}_dp01_alpha${alpha}_em${embedding_size}${loss_str}${cls_str}_s10_wd5e4_var2 \
