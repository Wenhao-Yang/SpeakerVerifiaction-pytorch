...
#  --channels 512,512,512,512,1500 \
  ...
  for filter in sinc2down; do
    ...
    python TrainAndTest/train_egs.py \
      ...
      --check-path Data/checkpoint/${model}/${datasets}/${feat_type}_egs_filter/${loss}_${optimizer}_${scheduler}/chn128_${input_norm}_${encoder_type}_${block_type}_dp${dropout_p}_alpha${alpha}_em${embedding_size}_wd5e4/${filter}${feat_dim}_bias2ddp054_adalr${lr_ratio} \
      --resume Data/checkpoint/${model}/${datasets}/${feat_type}_egs_filter/${loss}_${optimizer}_${scheduler}/chn128_${input_norm}_${encoder_type}_${block_type}_dp${dropout_p}_alpha${alpha}_em${embedding_size}_wd5e4/${filter}${feat_dim}_bias2ddp054_adalr${lr_ratio}/checkpoint_9.pth \
      --stride 1 \
...
#  feat_type=pyfb
  ...
  for lamda_beta in 2.0;do
    ...
    #   CUDA_VISIBLE_DEVICES=3,5 python -m torch.distributed.launch --nproc_per_node=2 --master_port=417410 --nnodes=1 TrainAndTest/train_egs_dist.py --train-config=TrainAndTest/Fbank/ResNets/aidata_resnet.yaml --seed=${seed}
       CUDA_VISIBLE_DEVICES=0,1,4,5 python -m torch.distributed.launch --nproc_per_node=4 --master_port=417430 --nnodes=1 TrainAndTest/train_egs_dist.py --train-config=TrainAndTest/Wav/vox2_ecapa.yaml --seed=${seed}
