...
@Software: PyCharm
@File: train_egs_var.py
@Time: 2021/5/24 12:19
@Overview:
"""
...
parser.add_argument('--var-input', action='store_true', default=False, help='need to make mfb file')
...
parser.add_argument('--min-chunk-size', type=int, default=200, metavar='CHUNK')
parser.add_argument('--max-chunk-size', type=int, default=400, metavar='CHUNK')
