...
#  _${weight}
   ...
   for encoder_type in AVG ; do
     ...
     python TrainAndTest/train_egs_kd.py \
       ...
       --check-path Data/checkpoint/${model}${resnet_size}/${datasets}/${feat_type}_egs_kd_${mask_layer}/${loss}_${optimizer}_${scheduler}/${input_norm}_${block_type}_${encoder_type}_dp20_alpha${alpha}_em${embedding_size}_wd5e4_chn32_var_${kd_type} \
       --resume Data/checkpoint/${model}${resnet_size}/${datasets}/${feat_type}_egs_kd_${mask_layer}/${loss}_${optimizer}_${scheduler}/${input_norm}_${block_type}_${encoder_type}_dp20_alpha${alpha}_em${embedding_size}_wd5e4_chn32_var_${kd_type}/checkpoint_50.pth \
       --kernel-size ${kernel} \
       --channels 32,64,128 \
       --stride 2 \
