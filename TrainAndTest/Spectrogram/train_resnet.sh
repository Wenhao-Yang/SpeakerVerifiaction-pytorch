...
if [ $stage -le 61 ]; then
 ...
 for seed in 123456 ; do
   ...
   CUDA_VISIBLE_DEVICES=4,5 OMP_NUM_THREADS=10 python -m torch.distributed.launch --nproc_per_node=2 --master_port=417420 TrainAndTest/train_egs_dist.py --train-config=TrainAndTest/Spectrogram/ResNets/vox2_resnet.yaml --seed=${seed}
