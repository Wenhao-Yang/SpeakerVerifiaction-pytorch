...
from Process_Data.KaldiDataset import KaldiExtractDataset, \
    ScriptVerifyDataset
from Process_Data.LmdbDataset import _read_data_lmdb, LmdbTrainDataset, LmdbTestDataset, LmdbValidDataset
...
parser.add_argument('--train-dir', type=str,
                    default='/home/work2020/yangwenhao/project/lstm_speaker_verification/data/vox1/lmdb/spect/dev_power',
                    help='path to dataset')
parser.add_argument('--test-dir', type=str,
                    default='/home/work2020/yangwenhao/project/lstm_speaker_verification/data/vox1/lmdb/spect/test_power',
...
parser.add_argument('--sitw-dir', type=str,
                    ...
                    help='path to voxceleb1 test dataset')
parser.add_argument('--nj', default=16, type=int, metavar='NJOB', help='num of job')
parser.add_argument('--feat-format', type=str, default='lmdb', choices=['kaldi', 'npy', 'lmdb'],
                    help='number of jobs to make feats (default: 10)')

parser.add_argument('--check-path', default='Data/checkpoint/GradResNet8/vox1/spect_lmdb/soft_dp25',
                    help='folder to output model checkpoints')
parser.add_argument('--save-init', action='store_true', default=True, help='need to make mfb file')
parser.add_argument('--resume', default='Data/checkpoint/GradResNet8/vox1/spect_lmdb/soft_dp25/checkpoint_10.pth',
                    type=str,
                    metavar='PATH',
...
parser.add_argument('--milestones', default='10,15,20', type=str,
...
if args.feat_format == 'kaldi':
    ...
    file_loader = np.load
elif args.feat_format == 'lmdb':
    file_loader = _read_data_lmdb

train_dir = LmdbTrainDataset(dir=args.train_dir, feat_dim=args.feat_dim, samples_per_speaker=args.input_per_spks,
                             loader=file_loader, transform=transform, num_valid=args.num_valid)

test_dir = LmdbTestDataset(dir=args.test_dir, feat_dim=args.feat_dim, loader=file_loader, transform=transform_T)
...
valid_dir = LmdbValidDataset(valid_set=train_dir.valid_set, loader=file_loader, feat_dim=args.feat_dim,
                             env=train_dir.env,
                             spk_to_idx=train_dir.spk_to_idx, valid_utt2spk_dict=train_dir.valid_utt2spk_dict,
                             transform=transform)
...
def train(train_loader, model, ce, optimizer, epoch):
    ...
    for batch_idx, (data, label) in pbar:
        ...
        predicted_one_labels = predicted_labels.max(dim=1)[1]
        minibatch_correct = float((predicted_one_labels == label).sum().item())
