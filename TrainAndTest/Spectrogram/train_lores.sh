...
if [ $stage -le 80 ]; then
  ...
  for loss in arcsoft; do
    ...
    python TrainAndTest/train_egs.py \
      ...
      --resume Data/checkpoint/${model}${resnet_size}/${datasets}/${feat_type}_egs_baseline/${loss}/${input_norm}_${block_type}_${encoder_type}_dp01_alpha${alpha}_em${embedding_size}_var/checkpoint_33.pth \
      --kernel-size ${kernel} \
      --channels 64,128,256 \
      --stride 2 \
      --batch-size 128 \
