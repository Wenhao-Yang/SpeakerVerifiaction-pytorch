...
if [ $stage -le 64 ]; then
  ...
  for loss in soft ; do
    ...
    python TrainAndTest/Spectrogram/train_egs_multi.py \
      --model ${model} \
      --train-dir-a ${lstm_dir}/data/${datasets}/egs/spect/aishell2_dev_8k_v2 \
      --train-dir-b ${lstm_dir}/data/${datasets}/egs/spect/vox_dev_8k_v2 \
      --train-test-dir ${lstm_dir}/data/${datasets}/spect/dev_8k_v2 \
      --valid-dir-a ${lstm_dir}/data/${datasets}/egs/spect/aishell2_valid_8k_v2 \
      --valid-dir-b ${lstm_dir}/data/${datasets}/egs/spect/vox_valid_8k_v2 \
      --test-dir ${lstm_dir}/data/${datasets}/spect/test_8k \
      --feat-format kaldi \
      --resnet-size ${resnet_size} \
      --input-norm Mean \
      ...
      --resume Data/checkpoint/${model}${resnet_size}/${datasets}_x2/spect_egs_${encod}/${loss}_dp25_b256_${alpha}_fast/checkpoint_29.pth \
