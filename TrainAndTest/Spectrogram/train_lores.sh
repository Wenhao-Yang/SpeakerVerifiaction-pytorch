...
#  mask_layer=gau_noise
  ...
  for weight in mel clean aug vox2; do
    ...
    python TrainAndTest/train_egs.py \
      ...
      --init-weight ${weight} \
      --milestones 10,20,30,40 \
      --check-path Data/checkpoint/${model}${resnet_size}/${datasets}/${feat_type}_egs_${mask_layer}/${loss}/${input_norm}_${block_type}_${encoder_type}_dp25_alpha${alpha}_em${embedding_size}_${weight}_wde3_chn32_var \
      --resume Data/checkpoint/${model}${resnet_size}/${datasets}/${feat_type}_egs_${mask_layer}/${loss}/${input_norm}_${block_type}_${encoder_type}_dp25_alpha${alpha}_em${embedding_size}_${weight}_wde3_chn32_var/checkpoint_50.pth \
      --kernel-size ${kernel} \
      --channels 32,64,128 \
      --stride 2 \
      --batch-size 128 \
