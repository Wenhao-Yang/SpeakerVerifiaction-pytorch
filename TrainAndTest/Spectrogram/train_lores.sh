...
if [ $stage -le 50 ]; then
  ...
  for loss in soft ; do
    ...
    python TrainAndTest/Spectrogram/train_egs.py \
      ...
      --lr 0.1 \
      --milestones 5,10,15 \
      --check-path Data/checkpoint/${model}${resnet_size}/${datasets}/spect_egs_STAP/${loss}_dp25_64_12 \
      --resume Data/checkpoint/${model}${resnet_size}/${datasets}/spect_egs_STAP/${loss}_dp25_64_12/checkpoint_24.pth \
