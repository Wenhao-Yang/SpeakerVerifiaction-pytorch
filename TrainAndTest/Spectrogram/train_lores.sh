...
#  mask_layer=gau_noise
  ...
  for weight in mel; do
    ...
    python TrainAndTest/train_egs.py \
      ...
      --init-weight ${weight} \
      --milestones 10,20,30,40 \
      --check-path Data/checkpoint/${model}${resnet_size}/${datasets}/${feat_type}_egs_${mask_layer}/${loss}_adam/${input_norm}_${block_type}_${encoder_type}_dp125_alpha${alpha}_em${embedding_size}_${weight}42_chn16_wd5e4_var \
      --resume Data/checkpoint/${model}${resnet_size}/${datasets}/${feat_type}_egs_${mask_layer}/${loss}_adam/${input_norm}_${block_type}_${encoder_type}_dp125_alpha${alpha}_em${embedding_size}_${weight}42_chn16_wd5e4_var/checkpoint_50.pth \
      --kernel-size ${kernel} \
      --channels 16,32,64 \
      --stride 2 \
      --batch-size 128 \
