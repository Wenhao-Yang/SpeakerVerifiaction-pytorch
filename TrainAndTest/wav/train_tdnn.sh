...
if [ $stage -le 5 ]; then
  ...
  for lamda_beta in 0.2;do
    ...
    #  feat=fb${input_dim}
      ...
      for seed in 1236 1237 ; do #1234 1235 1236 
     echo -e "\n\033[1;4;31m Stage ${stage}: Training ${model}_${encod} in ${datasets}_${feat} with ${loss}\033[0m\n"
      ...
      CUDA_VISIBLE_DEVICES=${gpu_id} OMP_NUM_THREADS=8 torchrun --nproc_per_node=2 --master_port=${master_port} --nnodes=1 TrainAndTest/train_egs/train_dist_coreset.py --train-config=TrainAndTest/wav/ecapa/data_dist/vox1_inst_aug53_mulop_min6.yaml --seed=${seed} --sample-ratio ${ratio}
