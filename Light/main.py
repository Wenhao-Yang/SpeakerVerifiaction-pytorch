...
def main():
    ...
    val_check_interval = max([math.gcd(int(len(train_loader)/2/(len(args.gpus.split(','))))+i, config_args['val_check_interval']+j) for i in range(-256, 256) for j in range(-256, 256)])
