...
def main():
    ...
    val_check_interval = max([math.gcd(int(len(train_loader)/(len(args.gpus.split(','))))+i, config_args['val_check_interval']+j) for i in range(0, 256) for j in range(-256, 256)])
