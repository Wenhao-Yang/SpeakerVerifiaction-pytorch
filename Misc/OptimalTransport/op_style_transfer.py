...
import numpy as np
from Misc.OptimalTransport.optimal_transport import OptimalTransport
...
lam = 10
n_neighbors = 10
name_from = 'Misc/OptimalTransport/Figures/PB2PC.jpg'
name_to = 'Misc/OptimalTransport/Figures/PC.jpg'
name_out = 'Misc/OptimalTransport/test.jpg'

arg_parser = argparse.ArgumentParser()

arg_parser.add_argument('-f', '--fr', type=str, default='Misc/OptimalTransport/Figures/PC.jpg',
                        help='image to take the color from')
arg_parser.add_argument('-t', '--to', type=str, default='Misc/OptimalTransport/Figures/PB.jpg',
                        help='image transform')
arg_parser.add_argument('-o', '--out', type=str, default='Misc/OptimalTransport/test.jpg',
